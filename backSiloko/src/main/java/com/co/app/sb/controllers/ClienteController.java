...
public class ClienteController {
	...
	/**
	 * Metodo que retorna un cliente basado en su documento de identificacion
	 * nacional
	 * 
	 * @return ResponseEntity<ClienteDto>
	 */
	@GetMapping("/documentoId")
	public ResponseEntity<ClienteDto> getClienteByDocumento(@RequestParam(value = "value") long documento)
			throws Exception {
		return ResponseEntity.ok(this.clienteService.getClienteByDocumento(documento));
	}

	/**
	 * Metodo que bloquea el cupo de credito de un cliente, cuando un funcionario
	 * envia la orden
	 * 
	...
	public ResponseEntity<CupoCreditoDto> setBloquearCupoCredito(@RequestParam(value = "cliente") long idCliente,
			@RequestParam(value = "funcionario") long idFuncionario) throws Exception {
		CupoCreditoDto res = this.cupoCreditoService.BloquearCupo(idCliente, idFuncionario);
		return ResponseEntity.ok(res);
	}

	/**
	 * Metodo que desbloquea el cupo de credito de un cliente, cuando un funcionario
	 * envia la orden
	 * 
	 * @param idCliente     id del cliente en la base de datos
	 * @param idFuncionario id del funcionario en la base de datos
	...
	public ResponseEntity<CupoCreditoDto> setDesbloquearCupoCredito(@RequestParam(value = "cliente") long idCliente,
			@RequestParam(value = "funcionario") long idFuncionario) throws Exception {
	...
	/**
	 * Metodo que genera el cupo de credito de un cliente, cuando un funcionario
	 * envia la orden
	 * 
	 * @param idCliente     id del cliente en la base de datos
	 * @param idFuncionario id del funcionario en la base de datos
	...
	public ResponseEntity<CupoCreditoDto> setGenerarCupoCredito(@RequestParam(value = "cliente") long idCliente,
			@RequestParam(value = "funcionario") long idFuncionario) throws Exception {
	...
	public ResponseEntity<CupoCreditoDto> setSaldoCupoCredito(@RequestParam(value = "funcionario") long idFuncionario,
			@RequestBody CupoCreditoDto cupo) throws Exception {
		CupoCreditoDto res = this.cupoCreditoService.AsignarCupoCreditoManual(idFuncionario, cupo.getId(),
				cupo.getTotalSizeCredit());
		return ResponseEntity.ok(res);
	}
	...
	@GetMapping("/productosTel")
	public ResponseEntity<List<ClienteProductoTelDto>> getProductosCliente(@RequestParam("value") long idCliente)
			throws Exception {
